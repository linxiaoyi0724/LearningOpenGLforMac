//
//  demoLearningMaterial.cpp
//  DemoForDrawTriangle_20210424
//
//  Created by linxiaoyi on 2021/8/18.
//
...
int main()
{
    ...
    myShaderProgram lightingShaderProgram("./vs/demoLearningMaterialLighting.vs", "./fs/demoLearningMaterialLighting.fs");
    myShaderProgram lightingCubeShaderProgram("./vs/demoLearningMaterialLightingCube.vs","./fs/demoLearningMaterialLightingCube.fs");
    ...
    while (!glfwWindowShouldClose(myGlfw::getInstance()->mWindow)) {
        ...
        lightingShaderProgram.setVec3("veiwPos", camera.mPosition);
        ...
        //material properties
        lightingShaderProgram.setVec3("material.ambient", glm::vec3(1.0f,0.5f,0.31f));
        lightingShaderProgram.setVec3("material.diffuse", glm::vec3(1.0f,0.5f,0.31f));
        ...
        glm::mat4 projection = glm::perspective(glm::radians(camera.mZoom), (float)SCR_WIDTH / (float)SCR_HIGHT, 0.1f, 100.0f);
