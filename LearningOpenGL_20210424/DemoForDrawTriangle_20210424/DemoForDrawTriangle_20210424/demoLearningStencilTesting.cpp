////
////  demoLearningStencilTesting.cpp
////  DemoForDrawTriangle_20210424
////
////  Created by linxiaoyi on 2021/11/4.
////
//
#include <iostream>
#include "myGlad.hpp"
...
int main(){
    ...
    myShaderProgram ourShader("./vs/demoLearningStencilTesting/demoLearningStencilTesting.vs","./fs/demoLearningStencilTesting/demoLearningStencilTesting.fs");
    myShaderProgram ourShaderSingleColor("./vs/demoLearningStencilTesting/demoLearningStencilTesting.vs","./fs/demoLearningStencilTesting/demoLearningStencilTestingColor.fs");
    ...
    while (!glfwWindowShouldClose(myGlfw::getInstance()->mWindow)) {
        ...
        ourShaderSingleColor.setMat4f("view", view);
        ourShaderSingleColor.setMat4f("projection", projection);
        ...
        ourShaderSingleColor.setMat4f("model", model);
        glDrawArrays(GL_TRIANGLES, 0, 36);
