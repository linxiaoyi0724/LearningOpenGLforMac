...
void myShaderProgram::setMat4f(const std::string& name, glm::mat4 value)const{
    glUniformMatrix4fv(glGetUniformLocation(shaderProgam,name.c_str()),1,GL_FALSE,glm::value_ptr(value));
}
